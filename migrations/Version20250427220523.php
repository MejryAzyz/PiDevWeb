 ...
 */
final class Version20250427220523 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE postulation DROP FOREIGN KEY FK_DA7D4E9B4103C75F
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE postulation ADD CONSTRAINT postulation_ibfk_2 FOREIGN KEY (id_offre) REFERENCES offreemploi (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
