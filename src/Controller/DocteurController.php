...
final class DocteurController extends AbstractController
{
    ...
    #[Route('/{idDocteur}', name: 'app_docteur_show', methods: ['GET'])]
    ...
    #[Route('/{idDocteur}/edit', name: 'app_docteur_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idDocteur}', name: 'app_docteur_delete', methods: ['POST'])]
    public function delete(Request $request, Docteur $docteur, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$docteur->getIdDocteur(), $request->getPayload()->getString('_token'))) {
