...
final class SpecialiteController extends AbstractController
{
    ...
    #[Route('/{id_specialite}', name: 'app_specialite_show', methods: ['GET'])]
    ...
    #[Route('/{id_specialite}/edit', name: 'app_specialite_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id_specialite}', name: 'app_specialite_delete', methods: ['POST'])]
    public function delete(Request $request, Specialite $specialite, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$specialite->getId_specialite(), $request->getPayload()->getString('_token'))) {
