...
var seriesData = [
  ...
  { x: new Date(2017, 8, 1), y: [54.80, 61.42, 53.18, 57.35] },
  { x: new Date(2017, 9, 1), y: [57.56, 63.09, 57.00, 62.99] },
...
// Simulated price data (e.g. scaled up for different axis)
var seriesData7 = [
  { x: new Date(2016, 1, 1), y: [1151.98, 1156.29, 1151.59, 1153.85] },
  { x: new Date(2016, 2, 1), y: [1153.66, 1154.99, 1151.35, 1152.95] },
  { x: new Date(2016, 3, 1), y: [1152.96, 1153.78, 1151.54, 1152.48] },
  { x: new Date(2016, 4, 1), y: [1152.54, 1152.79, 1147.88, 1149.24] },
  { x: new Date(2016, 5, 1), y: [1149.10, 1152.86, 1147.70, 1152.78] },
  { x: new Date(2016, 6, 1), y: [1152.83, 1153.48, 1150.32, 1152.29] },
  { x: new Date(2016, 7, 1), y: [1152.20, 1154.48, 1151.64, 1152.58] },
  { x: new Date(2016, 8, 1), y: [1152.76, 1157.35, 1152.15, 1157.03] },
  { x: new Date(2016, 9, 1), y: [1157.04, 1158.15, 1148.88, 1156.19] },
  { x: new Date(2016, 10, 1), y: [1156.09, 1158.85, 1155.48, 1158.79] },
  { x: new Date(2016, 11, 1), y: [1158.78, 1159.65, 1158.23, 1159.05] },
  { x: new Date(2017, 0, 1), y: [1159.37, 1161.11, 1159.35, 1160.34] },
  { x: new Date(2017, 1, 1), y: [1160.40, 1160.52, 1156.71, 1156.93] },
  { x: new Date(2017, 2, 1), y: [1157.02, 1159.71, 1156.04, 1156.82] },
  { x: new Date(2017, 3, 1), y: [1156.97, 1159.62, 1154.77, 1159.30] },
  { x: new Date(2017, 4, 1), y: [1159.11, 1162.29, 1159.10, 1159.85] },
  { x: new Date(2017, 5, 1), y: [1159.97, 1160.11, 1155.66, 1158.42] },
  { x: new Date(2017, 6, 1), y: [1158.34, 1160.93, 1156.75, 1157.42] },
  { x: new Date(2017, 7, 1), y: [1157.76, 1158.08, 1151.18, 1154.71] },
  { x: new Date(2017, 8, 1), y: [1154.80, 1161.42, 1153.18, 1157.35] },
  { x: new Date(2017, 9, 1), y: [1157.56, 1163.09, 1157.00, 1162.99] },
  { x: new Date(2017, 10, 1), y: [1162.89, 1163.42, 1159.72, 1161.76] },
  { x: new Date(2017, 11, 1), y: [1161.71, 1164.15, 1161.29, 1163.04] }
  // If you had more data here, you can add it below...
];
